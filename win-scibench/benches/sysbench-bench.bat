...
mkdir "-p" "!OUTDIR!"
hyperfine "sysbench cpu run --threads=!HALF_CORES!" "--runs" "10" "--warmup" "2" "--export-json" "!OUTDIR!/sysbench-cpu.json"
hyperfine "sysbench memory run --threads=!HALF_CORES!" "--runs" "10" "--warmup" "2" "--export-json" "!OUTDIR!/sysbench-mem.json"
hyperfine "sysbench mutex run --threads=!HALF_CORES!" "--runs" "10" "--warmup" "2" "--export-json" "!OUTDIR!/sysbench-mem.json"
